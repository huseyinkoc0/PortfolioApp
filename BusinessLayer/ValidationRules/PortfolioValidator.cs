...
namespace BusinessLayer.ValidationRules
{
    public class PortfolioValidator:AbstractValidator<Portfolio>
    {
        public PortfolioValidator()
        {
            ...
            RuleFor(x => x.Name).MinimumLength(5).WithMessage("En az 5 karakterden oluşmalıdır.");   
            RuleFor(x => x.Name).MaximumLength(150).WithMessage("En fazla 150 karakterden oluşmalıdır.");   
        }
